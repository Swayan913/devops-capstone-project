...
This repository contains the code for a customer accounts microservice 
built as part of the IBM DevOps and Software Engineering Capstone Project. 
The microservice provides a RESTful API to create, read, update, delete, 
and list customer accounts for an e-commerce platform. It is built using 
Python, Flask, and PostgreSQL, and follows the Model-View-Controller (MVC) 
pattern.
